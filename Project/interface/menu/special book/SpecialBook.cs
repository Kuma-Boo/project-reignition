...
public partial class SpecialBook : Menu
{
    ...
    [Export]
    private AudioStreamPlayer sfxOpen;

    [Export]
    private AudioStreamPlayer sfxSelect;

    [Export]
    private AudioStreamPlayer sfxCancel;

    [Export]
    private AudioStreamPlayer sfxConfirm;

    [Export]
    private AudioStreamPlayer sfxCategorySelect;


    private Array randomPages;
    ...
    int GetSelectionFromPage(BookPage page)
    {
        for (int chapter = 0; chapter < chapters.Length; chapter++)
        {
    ...
    int GetChapterFromPage(BookPage page)
    {
        for (int chapter = 0; chapter < chapters.Length; chapter++)
        {
            for (int pages = 0; pages < 15; pages++)
