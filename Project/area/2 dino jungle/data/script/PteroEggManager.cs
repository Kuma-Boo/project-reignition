...
public partial class PteroEggManager : Node3D
{
	...
	// Models
	[Export] public Array<PackedScene> eggModels;
	[Export] public Array<PackedScene> signModels;
	...
	{
		heldEggs.Clear();
		StageSettings.Instance.TriggeredCheckpoint += SaveNestStatus;
		StageSettings.Player.Damaged += Frighten;
		...
		for (int i = 0; i < eggs.Count; i++)
		{
			...
			eggs[i].SetType(type + 1, i, eggModels[type].Instantiate<Node3D>());
