...
{
	/// <summary> Scene to switch to after event is finished. </summary>
	...
	public override void _PhysicsProcess(double _)
	{
		...
		if (Input.IsActionPressed("button_pause") && Menu.menuMemory[Menu.MemoryKeys.ActiveMenu] != (int)Menu.MemoryKeys.SpecialBook) //Skip cutscene
		{
		...
		{
			TransitionManager.QueueSceneChange("res://interface/menu/special book/SpecialBook.tscn");
